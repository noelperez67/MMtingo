...
const dailyOffers = {
    ...
    6: { // Sábado
        ...
        offers: [
            { id: 40, nombre: 'Banana', precioOriginal: '$0.30', precioOferta: '$0.20', imagen: 'img/banana.jpg' },
...
function displayDailyOffers() {
    ...
    todayOffers.offers.forEach(offer => {
        ...
        slide.innerHTML = `
            ...
            <button class="agregar-carrito" data-id="${offer.id}">Agregar al Carrito</button>
        `;
...
// Inicializar el mapa
const map = L.map('map').setView([18.4811, -69.9417], 15);

// Cargar las capas de mapa (OpenStreetMap)
L.tileLayer('https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png', {
    attribution: '&copy; OpenStreetMap contributors'
}).addTo(map);

// Agregar un marcador al mapa
L.marker([18.4811, -69.9417])
    .addTo(map)
    .bindPopup('Plaza Agropecuaria Mamá Tingó')
    .openPopup();
